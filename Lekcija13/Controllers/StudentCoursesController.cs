...
namespace Lekcija13.Controllers
{
    public class StudentCoursesController : Controller
    {
        ...
        public StudentCoursesController(StudentiContext context)
        {
            _context = context;
        }
        ...
        {
            var studentiContext = _context.StudentCourses.Include(s => s.Course).Include(s => s.Student);
        ...
        public async Task<IActionResult> Create([Bind("Id,StudentId,CourseId")] StudentCourse studentCourse)
        {
            ...
            ViewData["StudentId"] = new SelectList(_context.Students, "StudentId", "FullName", studentCourse.StudentId);
            return View(studentCourse);
        }
